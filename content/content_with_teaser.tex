...
\title[Seminar Topic]%
      {Seminar Topic about Graph Layouting for Visualizing Graph Structured Data}
...
the citation index in square brackets, for example~\cite{herman2000graph}. Where
...
\item \textbf{one} author: first 3 chars plus year -- 
      e.g.\ \cite{Herman2000} , \cite{VonLandesberger2011} \cite{Goyal2018} \cite{Lhuillier2017} \cite{Vehlow2015} \cite{Gibson2013}
